...
<div class="container">
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <a href="edit_product.php?id=<?= $prod['id'] ?>" class="btn btn-edit">Edit</a>
                <a href="delete_product.php?id=<?= $prod['id'] ?>" class="btn btn-delete" onclick="return confirm('Are you sure you want to delete this product?');">Delete</a>
            </td>
        </tr>
        <?php endforeach; ?>
    </table>
