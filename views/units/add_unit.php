    ...
    <div class="form-card">
        ...
        <form method="POST" action="../../controllers/units.php">
            ...
            <div class="form-group">
                ...
                <input type="text" name="base_unit" placeholder="E.g. gram, ml" required>
            </div>

            <div class="form-group">
                <label>Conversion Factor</label>
                <input type="number" name="conversion_factor" step="0.001" placeholder="E.g. 1000" required>
            </div>

            <button type="submit" name="add_unit" class="btn-submit">Save Unit</button>
        </form>
